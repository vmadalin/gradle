...
class JavaToolchainQueryServiceTest extends Specification {
    ...
    def "returns failing provider if no toolchain matches"() {
        ...
        e.message == "Unable to download toolchain matching the requirements ({languageVersion=unspecified, vendor=any, implementation=vendor-specific}) from 'http://server.com', due to: " +
