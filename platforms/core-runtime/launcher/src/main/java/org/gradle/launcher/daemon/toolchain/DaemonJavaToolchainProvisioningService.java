...
public class DaemonJavaToolchainProvisioningService implements JavaToolchainProvisioningService {
    ...
    public DaemonJavaToolchainProvisioningService(SecureFileDownloader downloader, DefaultJdkCacheDirectory cacheDirProvider, BuildPlatform buildPlatform, ToolchainDownloadUrlProvider toolchainDownloadUrlProvider, Boolean isAutoDownloadEnabled) {
