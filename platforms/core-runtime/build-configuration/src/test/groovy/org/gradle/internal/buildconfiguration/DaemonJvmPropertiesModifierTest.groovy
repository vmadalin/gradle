...
class DaemonJvmPropertiesModifierTest extends Specification {
    ...
    def "writes expected properties into file"() {
        ...
        when:
        propertiesModifier.updateJvmCriteria(daemonJvmPropertiesFile, JavaVersion.VERSION_11, "IBM", JvmImplementation.VENDOR_SPECIFIC)
        then:
    ...
    private class FakeResolver implements ToolchainRepositoriesResolver {
        ...
        @Override
        Map<BuildPlatform, Optional<URI>> resolveToolchainDownloadUrlsByPlatform(JavaVersion toolchainVersion, @Nullable String toolchainVendor, @Nullable JvmImplementation toolchainImplementation) throws UnconfiguredToolchainRepositoriesResolver {
